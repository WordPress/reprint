    ...
    beforeAll(async () => {
        await ensureSite(site, {
            ...
            customDb: async (_database, connection) => {
                await createManyRowData(connection, firstTable);
                ...
                await createBoundedPayloadData(connection, boundedPayloadTable);
                await createLargeSingleRowData(connection, splitPayloadTable);
