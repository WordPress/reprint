...
class BuildPdoDsnTest extends TestCase
{
    ...
    {
        $dsn = Utils::build_pdo_dsn("localhost:{$this->tmpSocket}", 'wp_db');
    ...
    {
        $dsn = Utils::build_pdo_dsn('localhost:/no/such/file.sock', 'wp_db');
    ...
    {
        $dsn = Utils::build_pdo_dsn('2001:db8::1', 'wp_db');
