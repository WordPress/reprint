...
final class Utils
{
     ...
     * Examples:
     *
     *     Utils::trim_right_slash('/srv/site///'); // '/srv/site'
     *     Utils::trim_right_slash('/');            // '/'
     *     Utils::trim_right_slash('');             // '/'
     *
     ...
     */
    public static function trim_right_slash(string $path): string
    {
        return rtrim($path, '/') ?: '/';
    }
    ...
    public static function realpath_with_missing_tail(string $absolute_path): string
    {
        ...
        $normalized_path = self::normalize_path($absolute_path);
        $missing_components = [];
        ...
        if ($missing_components === []) {
            return self::normalize_path($canonical_existing_ancestor);
        }
     ...
     * Utils::path_is_same_as_or_descendant_of(), equal paths do not match. The
     ...
     */
    public static function assert_valid_path(string $path, string $label = "path"): void
    {
        $path = trim($path);
        if ($path === "") {
