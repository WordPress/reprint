 ...
 *
 * ReverseTransport (with TransportYield) is the transport the importer talks to;
 * ReverseTransportEndpoint is the remote endpoint; ReverseTransportWorker is the outbound-only local
...
require_once __DIR__ . '/class-reverse-transport-worker.php';
