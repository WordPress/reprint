...
if (
    ...
    $option_defs = [
        ...
        [
            ...
            'help' => 'Omit the source Reprint plugin, credentials, and activation entries (default for new state; requires an updated source server)',
            'help_section' => 'global',
        ...
        [
            ...
            'target' => 'exclude_reprint',
            'flag_value' => false,
            'help' => 'Keep the source Reprint plugin and connection state (saved in state)',
            'help_section' => 'global',
            'commands' => ['pull', 'pull-files', 'pull-db', 'files-pull', 'db-pull'],
        ],
        [
